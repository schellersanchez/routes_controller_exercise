...
This might take awhile, afterwards  you will need to run:
    ...
    $ rake db:create
    $ rake db:migrate
	## I got an error "You have already activated rake 0.9.3.beta.1É"
	## To resolve, I modified the Gemfile.lock to use rake 0.9.3.beta.1
	## -scheller
...
It is loading users data from database
